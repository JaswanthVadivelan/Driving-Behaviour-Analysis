...
NAV_PAGE_MAP = {
    ...
    "Fleet Map":          "pages/07_fleet_map.py",
    "Driver Leaderboard": "pages/08_driver_leaderboard.py",
    "Risk Heatmap":       "pages/09_risk_heatmap.py",
    "Vehicle Profile":    "pages/06_vehicle_profile.py",
